...
ขั้นตอนต่อจากนี้  จะเป็นทดสอบ บันทึกข้อมูลเข้าไปในระบบ และ ประมวลผล เพื่อดูข้อมูลหลังจากที่ระบบทำการประมวลผล



ขั้นตอน การ บันทึกข้อมูลทดสอบ ดังนี้

```
เปิดโปรแกรม HOSxp PCU(สีเขียว) ที่ใช้งานประจำ เพื่อบันทึกผลแลป
```

![2018-12-12 006](pic/2018-12-12 006.png)


  ทำการเลือกผู้ป่วย  One Stop Service และ 

   1. กดที่ “`บันทึกผลแลป`”
   
   2. เลือกที่ชื่อแลป และ กด “`สั่งแลป`”


   ![2019-02-20 002](pic/2019-02-20 002.png)



3. เลือก “`รายการที่ต้องการ`”  และ เลือกติ๊ก แลปที่ต้องการ  หรือ หาก รายการแลป ตัวใด ไม่มี สามารถ กด ปุ่ม “`รายการที่สั่ง`”
4. กด ปุ่ม “`บันทึก`”


![2019-02-20 003](pic/2019-02-20 003.png)

5. หลังจากนั้น กด “`บันทึกแลป`” 

![2019-02-20 005](pic/2019-02-20 005.png)

6. ลงบันทึก ค่า แลป ที่มีการรายงานผล ในตัวอย่างนี้ บันทึก ทั้งหมด 16 รายการ

7. กดปุ่ม “`Confirm All`” 

8. กดปุ่ม “`Save`”

   ![2019-02-20 006](pic/2019-02-20 006.png)
...
ขั้นตอน การประมวลผล 
```
6.1 ดับเบิลคลิกเปิดโปรแกรม BMSHOSxPStandard43Export(สีขาว)
```

![2018-12-10 008](https://raw.githubusercontent.com/inforeportable/EXPORT_SETTING_LABFU/master/labfu_setting/pic/2018-12-10 008.png)

```
6.2 ให้ทำการตรวจสอบ Scrip ที่ทำการประมวลผล

6.3 ทำการ เลือก “Local MySQL Processing” เพื่อลด Error ข้อมูล และ ความเร็วในการประมวลผล
```



![2019-02-20 007](pic/2019-02-20 007.png)

![2019-02-20 008](pic/2019-02-20 008.png)

6.4 กด ปุ่ม “Start Export”

![2019-02-20 010](pic/2019-02-20 010.png)

6.5 ผลลัพธ์ ที่ได้

![2019-02-20 012](pic/2019-02-20 012.png)
